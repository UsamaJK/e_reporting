...
class SimpleReportingScreen extends StatefulWidget {
  static const String routeName = "/SimpleReportingScreen";
  const SimpleReportingScreen({Key? key}) : super(key: key);

  @override
  _SimpleReportingScreenState createState() => _SimpleReportingScreenState();
}

class _SimpleReportingScreenState extends State<SimpleReportingScreen> {
